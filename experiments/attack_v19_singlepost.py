...
REPLAY_COST_COEF = 0.95  # charge 95% of observed replay cost (v169 +0.765 lever)
...
SLOW_MULTIPOST_N = 1  # single-post (Jun-Morita README: multipost is consistently negative)
